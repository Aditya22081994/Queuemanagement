...
.sectOne{
	background-image: url('https://www.omnihotels.com/-/media/images/hotels/nycber/destinations/nyc-aerial-skyline.jpg?h=660&la=en&w=1170');
	opacity: 0.8;
}
...
<%! String name = null; 
String bankingofficer=null;%>
<nav>
<%
bankingofficer=request.getAttribute("BankingOfficer").toString();  
